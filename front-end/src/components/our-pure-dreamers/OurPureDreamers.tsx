    ...
    <div className="bg-white relative py-10">
      ...
      <Container>
        <div className="mt-28 mb-4 text-center">
          <span className="text-zinc-900 text-6xl font-extrabold  leading-[72px]">
            OUR{" "}
          </span>
          <span className="text-pink-500 text-6xl font-extrabold  leading-[72px]">
            PURE DREAMERS
          </span>
        </div>
          ...
          <div className="px-4 py-8 flex items-center gap-10 sm:h-[400px] sm:px-10 xl:px-60">
            ...
            <div className="flex flex-col items-start gap-6">
              <div className="flex flex-col items-start gap-2">
                <div className="text-center text-pink-500 text-[24px] sm:text-[32px] font-bold  leading-[28px] sm:leading-[38.40px]">
                  Elly
                </div>
                <div className="text-center text-gray-700 text-lg sm:text-2xl font-medium  leading-[24px] sm:leading-[28.80px]">
                  Staff of Pure
                </div>
              </div>
