...
import creators from "@/components/our-pure-dreamers/creators.constanst";
        ...
        >
          {creators.map((creator, i) => {
            return (
              <div
                key={i}
                className='px-20 py-8 flex flex-col lg:flex-row items-center gap-10 lg:h-[400px] h-full sm:px-28 xl:px-48'
              >
                <Image
                  className='rounded-full sm:w-full !w-[260px] sm:mt-0 mt-20'
                  layout='responsive'
                  width={400}
                  height={400}
                  src={creator.avatar}
                ...
                <div className='flex flex-col lg:items-start gap-6'>
                  <div className='flex flex-col lg:items-start gap-2'>
                    <p className="text-center text-pink-500 text-[24px] sm:text-[32px] font-bold font-['Montserrat'] leading-[28px] sm:leading-[38.40px]">
                      {creator.name}
                    </p>
                    <p className="text-center text-gray-700 text-lg sm:text-2xl font-medium font-['Montserrat'] leading-[24px] sm:leading-[28.80px]">
                      {creator.position}
                    </p>
                  </div>
                  <p className="text-slate-500 text-base sm:text-lg font-medium font-['Montserrat'] leading-[24px] xl:leading-[28.80px]">
                    {creator.introduce}
                  </p>
