    ...
    <div className="relative bg-gradient-to-t from-primary-pink from-0% to-30% to-transparent  h-[480px] lg:h-[670px] " id="home">
      ...
      <Container>
        <div className="relative pt-32 lg:pt-36 ml-auto ">
          <TextAnimation />
          <button type="button" className="flex p-2 text-center group mx-auto items-center gap-2 rounded-full bg-opacity-30 backdrop-blur-md backdrop-filter">
            ...
            <div className="w-9 h-9 relative">
              ...
              <div className="w-3 h-3 left-[12px] top-[12px] absolute justify-center items-center inline-flex">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" className="group-hover:rotate-[135deg] duration-300" xmlns="http://www.w3.org/2000/svg">
