    ...
    <div className="relative bg-gradient-to-t from-primary-pink from-0% to-30% to-transparent  h-[480px] lg:h-[670px] " id="home">
      ...
      <Container>
        <div className="relative pt-32 lg:pt-36 ml-auto ">
          <TextAnimation />
          <button type="button" className="flex px-2 py-1 text-center group mx-auto items-center gap-2  border-yellow-400 hover:bg-sky-400 hover:border-sky-400 border-[3px]  rounded-full">
            <p className="text-white text-center text-xl lg:text-2xl font-extrabold leading-normal capitalize">START YOUR DREAM</p>
            <div className="w-9 h-9 relative">
              <div className="w-9 h-9 left-0 top-0 absolute bg-[#FF3EA5] rounded-[100px]" />
              <div className="w-3 h-3 left-[12px] top-[12px] text-white absolute justify-center items-center inline-flex">
                <svg width="12" height="12" viewBox="0 0 12 12" className="text-white group-hover:rotate-[135deg] duration-300" xmlns="http://www.w3.org/2000/svg">
