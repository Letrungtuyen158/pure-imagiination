      ...
      <Container>
        ...
        <Carousel
          ...
          <div className="px-4 py-8 flex items-center gap-10 sm:h-[400px] sm:px-10 xl:px-60">
            <Image className="rounded-full" width={400} height={400} src="https://via.placeholder.com/400x400" alt="Elly Image" />
            <div className="flex flex-col items-start gap-6">
              <div className="flex flex-col items-start gap-2">
                <div className="text-center text-pink-500 text-[24px] sm:text-[32px] font-bold  leading-[28px] sm:leading-[38.40px]">Elly</div>
                <div className="text-center text-gray-700 text-lg sm:text-2xl font-medium  leading-[24px] sm:leading-[28.80px]">Staff of Pure</div>
              </div>
              <div className="text-slate-500 text-base sm:text-lg font-medium  leading-[24px] sm:leading-[28.80px]">
                Ely It Clean aka Ely Nguyen is a beloved creator known for her captivating charm and innovative culinary content. Her delightful personality and fresh approach to cooking have
                resonated with a wide audience. We have proudly supported Ely since her early days, and in just one year, she has achieved remarkable success with 1 million followers, while making a
