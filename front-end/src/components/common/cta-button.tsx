...
export default function CtaButton({
  ...
  return (
    <button
      className={cn(
        "pl-4 group pr-2 py-2 bg-pink-500 rounded-[100px] justify-start items-center gap-2 inline-flex"
      )}
    >
      <div className={cn("text-center text-white ", className)}>{children}</div>
